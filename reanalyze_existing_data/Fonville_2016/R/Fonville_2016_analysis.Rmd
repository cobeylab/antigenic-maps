...
merged_distances %>%
 ...
 # geom_segment(aes(x = x_dodge-.2, xend = x_dodge+.2, y = expected_logtiter_adjusted_distance, yend = expected_logtiter_adjusted_distance), color = 'deepskyblue') +
  ...
  facet_wrap(.~subject_label) +
  ylab('log2 titer')
ggsave('../../draft_manuscript_figures/plots/primary_representative_indiv.png', width = 3, height = 3, dpi = 300, units = 'in')
```
...
read_csv('../../Ha_Nam/processed_data/PCR_infections.csv') %>%
  ...
  ylab('log2 titer') +
  xlab('strain')
ggsave('../plots/one_example_secondary_infection_comparison.png', width = 9, height = 6, dpi = 300, units = 'in')
```
