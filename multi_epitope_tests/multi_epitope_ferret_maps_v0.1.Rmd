...
```{r}
even_immunodominance$inferred_map_plot + ggtitle('even') + theme(legend.position = 'none') + facet_grid(allele~chain, labeller = label_both)
```


```{r}
skewed_immunodominance$inferred_map_plot + ggtitle('skewed') + theme(legend.position = 'none')  + facet_grid(allele~chain, labeller = label_both)
```


```{r}
E1_complete_immunodominance$inferred_map_plot+ ggtitle('all or nothing') + theme(legend.position = 'none')  + facet_grid(allele~chain, labeller = label_both) 


E1_complete_immunodominance$titer_map
```
