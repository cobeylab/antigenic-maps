...
ggsave('../plots/ferret_experiment_inferred_map_evolving.png', width = 10, height = 4, units = 'in')
```


```{r}
cowplot::plot_grid(plot_compare_distances(even_immunodominance) + theme(legend.position = 'none') + ggtitle('even immunodominance'),
                  plot_compare_distances(skewed_immunodominance) + theme(legend.position = 'none') + ggtitle('skewed_immunodominance'),
                  plot_compare_distances(E1_complete_immunodominance) + theme(legend.position = 'none') + ggtitle('all or nothing E1 immunodominance'),
                  nrow = 1
)
ggsave('../plots/ferret_experiment_gof_line_evolving.png', width = 10, height = 4, units = 'in')
```

```{r}
cowplot::plot_grid(plot_Ab_Ag_map(even_immunodominance$ag_ab_coords, antigen_coords) + theme(legend.position = 'none') + ggtitle('even immunodominance'),
                  plot_Ab_Ag_map(skewed_immunodominance$ag_ab_coords, antigen_coords) + theme(legend.position = 'none') + ggtitle('skewed_immunodominance'),
                  plot_Ab_Ag_map(E1_complete_immunodominance$ag_ab_coords, antigen_coords) + theme(legend.position = 'none') + ggtitle('all or nothing E1 immunodominance'),
                  nrow = 1
)
ggsave('../plots/ferret_experiment_AbAg_evolving.png', width = 10, height = 4, units = 'in')
```
