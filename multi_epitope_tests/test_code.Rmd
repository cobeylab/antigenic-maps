...
## 0.1. Code runs when there's only one Ab per epitope?
...
Infer maps
```{r}
oneAb_per_epitope <- infer_titer_map(antigen_coords = antigen_coords, relative_concentrations = c(1,1,1), n_epitopes = 3, n_antigens = 5, n_abs_per_serum = 3, plotdir = 'test_1Ab_per_epitope')
```
Plot heatmap
```{r}
...
one_epitope_no_ab_jitter <- infer_titer_map(antigen_coords = antigen_coords, 
...
![](2022-02-11/test01_one_epitope_no_ab_jitter/epitope_strain_map.png)
...
Infer titer map
```{r echo=FALSE, include=FALSE}
one_epitope_no_ab_withjitter <- infer_titer_map(antigen_coords = antigen_coords, 
                                            relative_concentrations = c(1),
                                            n_epitopes = 1, 
                                            n_antigens = 5, 
                                            n_abs_per_serum = 10, 
                                            plotdir = 'test02_one_epitope_no_ab_withjitter', sigma = 1)
```
...
![](2022-02-11/test02_one_epitope_no_ab_withjitter/epitope_strain_map.png)
...
![](2022-02-11/test03_3epitopes_E1dominant/epitope_strain_map.png)
